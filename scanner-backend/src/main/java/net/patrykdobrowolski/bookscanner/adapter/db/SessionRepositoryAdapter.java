package net.patrykdobrowolski.bookscanner.adapter.db;

import jakarta.inject.Named;
import lombok.RequiredArgsConstructor;
import net.patrykdobrowolski.bookscanner.adapter.db.entity.SessionEntity;
import net.patrykdobrowolski.bookscanner.adapter.db.mapper.SessionEntityMapper;
import net.patrykdobrowolski.bookscanner.adapter.db.repository.SpringDataSessionRepository;
