...
import net.patrykdobrowolski.bookscanner.adapter.rest.dto.DeleteDraftBookCommandDto;
import net.patrykdobrowolski.bookscanner.adapter.rest.dto.DraftBookDto;
import net.patrykdobrowolski.bookscanner.adapter.rest.mapper.EditDraftBookCommandDtoMapper;
...
import net.patrykdobrowolski.bookscanner.adapter.rest.dto.CreateDraftBookRequestDto;
import net.patrykdobrowolski.bookscanner.adapter.rest.dto.EditDraftBookCommandDto;
import net.patrykdobrowolski.bookscanner.adapter.rest.mapper.DraftBookDtoMapper;
