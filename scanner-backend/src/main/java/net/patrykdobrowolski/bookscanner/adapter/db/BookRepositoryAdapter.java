...
import net.patrykdobrowolski.bookscanner.adapter.db.mapper.BookEntityMapper;
import net.patrykdobrowolski.bookscanner.adapter.db.repository.SpringDataBookRepository;
